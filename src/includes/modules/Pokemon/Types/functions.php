...
define("TYPE_COLORS", [
    "bug"          => [ Color::Green, Color::Black ],
    "dark"         => [ Color::Black, Color::White ],
    "dragon"       => [ Color::Teal, Color::Black ],
    "electric"     => [ Color::Yellow, Color::Black ],
    "fighting"     => [ Color::Maroon, Color::White ],
    "fire"         => [ Color::Red, Color::Black ],
    "flying"       => [ Color::Light_Gray, Color::Black ],
    "ghost"        => [ Color::Purple, Color::Black ],
    "grass"        => [ Color::Lime, Color::Black ],
    "ground"       => [ Color::Orange, Color::Black ],
    "ice"          => [ Color::Aqua, Color::Black ],
    "normal"       => [ Color::White, Color::Black ],
    "poison"       => [ Color::Purple, Color::Black ],
    "psychic"      => [ Color::Fuchsia, Color::Black ],
    "rock"         => [ Color::Orange, Color::Black ],
    "steel"        => [ Color::Gray, Color::Black ],
    "water"        => [ Color::Blue, Color::Black ],
    "fairy"        => [ Color::Fuchsia, Color::Black ],
