...
class MetaPokemonInfoFormat extends InfoFormat {
    ...
    protected static $validFields = [
        ...
        "abilities", "moves", "items",
        "spreads", "teammates", "counters",
        "abilities1", "abilities2", "abilities3",
        "moves1", "moves2", "moves3", "moves4", "moves5",
        "items1", "items2", "items3", "items4", "items5",
        "spreads1", "spreads2", "spreads3", "spreads4", "spreads5",
        "teammates1", "teammates2", "teammates3", "teammates4", "teammates5",
        "counters1", "counters2", "counters3", "counters4", "counters5",
        "tier",
        "pickPercent", "pickRank"
    ];
