...
define("TYPE_COLORS", array(
    "bug"           => array("green", null),
    "dark"          => array("black", "white"),
    "dragon"        => array("teal", null),
    "electric"      => array("yellow", "black"),
    "fighting"      => array("maroon", null),
    "fire"          => array("red", null),
    "flying"        => array("light gray", "black"),
    "ghost"         => array("purple", null),
    "grass"         => array("lime", "black"),
    "ground"        => array("orange", null),
    "ice"           => array("aqua", "black"),
    "normal"        => array("white", "black"),
    "poison"        => array("purple", null),
    "psychic"       => array("fuchsia", null),
    "rock"          => array("orange", null),
    "steel"         => array("gray", null),
    "water"         => array("blue", null),
    "fairy"         => array("fuchsia", null),
    "bird"          => array("light gray", "black"),
    "flying press"  => array("maroon", null),
...
function colorType($types, $bold = false, $delimeter = "/") {
    ...
    foreach ($types as $key => $type) {
        ...
        $types[$key] = color(ucfirst($typeName), TYPE_COLORS[$typeName][0], TYPE_COLORS[$typeName][1]);
        //	Optionally bold
        if ($bold)
...
function defensiveAbilityEffect($attacking, $ability, $effectiveness = 1) {
    ...
    if (array_key_exists($attacking, DEFENSIVE_ABILITY_EFFECTS[$ability]))
    ...
    elseif (array_key_exists($ability, DEFENSIVE_ABILITY_EFFECTS['special'])) {
        $params = DEFENSIVE_ABILITY_EFFECTS[$ability];
