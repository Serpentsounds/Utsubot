...
abstract class DatabaseCredentials {
     ...
     * File should be in ini format, and the keyword passed in to the factory method should be one of the top level sections.
     * Valid fields are driver, host, username, and password.
     * All additional fields should be used in a getDSNFromConfig() implementation to construct the dsn.
     */
    ...
    /**
     * Given an array of values from the config ini file, this method should construct a valid DSN for the driver of this implentation.
     *
     * @param array $config
     * @return string
     */
