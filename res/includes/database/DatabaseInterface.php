...
class DatabaseInterface {
	 ...
	 */
	public function disconnect(array &$statements = array()) {
		if (count($statements)) {
	 ...
	 * @return array|bool|int Results set for SELECT, affected rows for INSERT/DELETE, false returns by the respective PDO methods will bubble
