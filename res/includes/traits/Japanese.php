...
trait Japanese {
    ...
    protected static $hiragana = array(
        'きゃ', 'きゅ', 'きょ',
        'しゃ', 'しゅ', 'しょ',
        'ちゃ', 'ちゅ', 'ちょ',
        'にゃ', 'にゅ', 'にょ',
    ...
    protected static $katakana = array(
        'キャ', 'キュ', 'キョ',
        'シャ', 'シュ', 'ショ',
        'チャ', 'チュ', 'チョ',
        'ニャ', 'ニュ', 'ニョ',
    ...
    protected static $extraKatakana = array(
        'ヴァ', 'ヴィ', 'ヴ', 'ヴェ', 'ヴォ',
        'ウィ', 'ウェ', 'ウォ',
        'ファ', 'フィ', 'フェ', 'フォ',
        'ティ', 'ディ',
    ...
    protected static $romanization = array(
        'kya', 'kyu', 'kyo',
        'sha', 'shu', 'sho',
        'cha', 'chu', 'cho',
        'nya', 'nyu', 'nyo',
    ...
    protected static $extraKatakanaRomanization = array(
        'va', 'vi', 'vu', 've', 'vo',
        'wi', 'we', 'wo',
        'fa', 'fi', 'fe', 'fo',
        'ti', 'di',
     ...
     * @return string
     */
    public static function romanizeKana(string $kana): string {
        ...
        $kana = str_replace(self::$extraKatakana, self::$extraKatakanaRomanization, $kana);

        //	Replace katakana with romaji
        $kana = str_replace(self::$katakana, self::$romanization, $kana);

        //	Replace hiragana with romaji
        $kana = str_replace(self::$hiragana, self::$romanization, $kana);
