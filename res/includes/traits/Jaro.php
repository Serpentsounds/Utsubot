...
trait Jaro {
     ...
     */
    private static function getMatchingCharacters(string $base, string $comparison): string {
     ...
     */
    public static function jaroDistance(string $base, string $comparison): float {
        $lengths = array(strlen($base), strlen($comparison));
     ...
     */
    public static function jaroWinklerDistance(string $base, string $comparison, int $prefixLength = 4, float $prefixScale = 0.1): float {
